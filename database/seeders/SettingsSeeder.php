...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('settings')->insert([
            // Site title.
            ['option_name' => 'app_name', 'option_value' => 'Rv Park HQ'],
            ...
            // Site logo and icons.
            ['option_name' => 'site_logo_lite', 'option_value' => '/images/logo/icon.jpg'],
            ['option_name' => 'site_logo_dark', 'option_value' => '/images/logo/icon.jpg'],
            ['option_name' => 'site_icon', 'option_value' => '/images/logo/icon.jpg'],
            ['option_name' => 'site_favicon', 'option_value' => '/images/logo/icon.jpg'],
