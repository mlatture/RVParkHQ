        ...
        <div class="space-y-5">
          @include('backend.layouts.partials.messages')
            ...
            <div>
                ...
                @error('type')
                <span class="text-sm text-error-500 mt-1 block">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="mt-4 text-sm flex justify-around text-gray-600 dark:text-gray-400">
                <span>{{ __('Don’t have an account?') }}</span>
                <a href="{{ route('admin.register') }}" class="text-brand-600 hover:underline dark:text-brand-400">
                    {{ __('Register here') }}
                </a>
            </div>
