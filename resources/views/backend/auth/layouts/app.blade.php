...
{{--                        class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">--}}
                    <div class="relative items-center hidden w-full h-full dark:bg-white/5 lg:grid lg:w-1/2">
                        <img src="/images/login.jpg" alt="image" class="absolute inset-0 w-full h-full object-cover" />
...
{{--                            <div class="flex flex-col items-center max-w-xs h-64">--}}
{{--                                <a href="#" class="block mb-4">--}}
{{--                                    <img src="/images/logo/icon.jpg" alt="Logo">--}}
{{--                                </a>--}}
