...
<div id="ajaxLoader" class="fixed inset-0 z-50 flex items-center justify-center hidden">
    <div class="h-16 w-16 animate-spin rounded-full border-4 border-solid border-white border-t-transparent"></div>
</div>
