...
@section('title')
    {{ __('Blogs') }} | {{ config('app.name') }}
@endsection

@section('admin-content')

    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <div x-data="{ pageName: {{ __('Blogs') }} }">
            <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
                ...
                <nav>
                    <ol class="flex items-center gap-1.5">
                        ...
                        <li class="text-sm text-gray-800 dark:text-white/90">{{ __('Blogs') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between items-center">
                    <h3 class="text-base font-medium text-gray-800 dark:text-white/90">{{ __('Blogs') }}</h3>
                ...
                <div class="space-y-3 border-t border-gray-100 dark:border-gray-800 overflow-x-auto">
                    ...
                    <table id="dataTable" class="w-full dark:text-gray-400">
                        ...
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <th class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5">{{ __('Thumbnail') }}</th>
                            ...
                            <th class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5">{{ __('Author') }}</th>
                            <th class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5">{{ __('Published') }}</th>
                        ...
                        @forelse ($blogs as $blog)
                            <tr class="'border-b border-gray-100 dark:border-gray-800'">
                                ...
                                <td class="px-5 py-4 sm:px-6">
                                    <img src="{{ asset('storage/' . $blog->thumbnail) }}" alt="Black Icon" width="60" height="60">
                                </td>
                                <td class="px-5 py-4 sm:px-6">{{ $blog->title }}</td>
                                <td class="px-5 py-4 sm:px-6">
                                    <span class="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200">
                                        {{ ucfirst($blog->status) }}
                                    </span>
                                </td>
                                <td class="px-5 py-4 sm:px-6">{{ $blog->user->email }}</td>
                                <td class="px-5 py-4 sm:px-6">{{ $blog->published_at }}</td>
                                    ...
                                    <div id="delete-modal-{{ $blog->id }}" tabindex="-1"
                                        ...
                                        <div
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{{ __('Are you sure you want to delete this Blogs?') }}</h3>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-4">
                                    <p class="text-gray-500 dark:text-gray-400">{{ __('No Blogs found') }}</p>
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
