...
@section('content')
            ...
            <div class="row carousel-description-clients carousel-description-style ">
                <div class="col-lg-4">
                    <div class="description">
                        <h2>Our Clients</h2> Aliquam enim enim, pharetra in sodales at, interdum sit amet dui. Nullam
                        vulputate euis od urna non pharetra. Phasellus bland matt is ipsum, ac laoreet lorem lacinia et.
                        interum sit amet dui.
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="carousel client-logos" data-items="4">
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/1.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/2.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/3.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/4.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/5.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/6.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/7.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/8.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/9.png">
                            </a>
                        </div>
                        <div>
                            <a href="#"><img alt="" src="assets/images/clients/10.png">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="call-to-action background-image p-t-100 p-b-100"
         style="background-image:url(assets/images/parallax/7.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-10">
                    <h3 class="text-light">Join by April 27 and <span>Win $200</span> in Programs and Services</h3>
                    <p class="text-light">This is a simple hero unit, a simple call-to-action-style component for
                        calling extra attention to featured content.</p>
                </div>
