...
@section('content')
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="text-center mb-5">
                <span class="badge bg-primary-soft text-primary mb-3">SUCCESS STORIES</span>
                <h2 class="mb-3 display-5 fw-bold">Trusted by Outdoor Brands</h2>
            </div>

            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="testimonial-card card border-0 rounded-4 overflow-hidden h-100 shadow-sm">
                        <div class="card-body p-4 p-xl-5 position-relative">
                            <div class="quote-icon text-primary opacity-10">
                        ...
                        <div class="card-footer bg-primary-soft border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="ms-2 small">Featured Listing</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="testimonial-card card border-0 rounded-4 overflow-hidden h-100 shadow-sm">
                        ...
                        <div class="card-footer bg-primary-soft border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <i class="bi bi-star-fill text-warning me-1"></i>
                                <i class="bi bi-star-fill text-warning"></i>
                                <span class="ms-2 small">Newsletter Ads</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="testimonial-card card border-0 rounded-4 overflow-hidden h-100 shadow-sm">
                        ...
                        <div class="card-footer bg-primary-soft border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="ms-2 small">Category Sponsor</span>
                            </div>
                        </div>
                    </div>
                </div>
