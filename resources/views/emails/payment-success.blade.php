            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 6px; overflow: hidden;">
                ...
                <tr>
                    <td style="padding: 30px;">
                        <p style="font-size: 16px;">Dear {{ $bill->user->name }},</p>
                        <p style="font-size: 16px;">
                            Your payment of <strong>${{ number_format($bill->amount, 2) }}</strong> for the bill
                            <strong>{{ $bill->subject }}</strong> has been successfully processed.
                        </p>
